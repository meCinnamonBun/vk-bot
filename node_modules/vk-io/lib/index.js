...
(function (APIErrorCode) {
     ...
     * Code: `1409`
     */
    APIErrorCode[APIErrorCode["MARKET_SHOP_NOT_ENABLED"] = 1409] = "MARKET_SHOP_NOT_ENABLED";
    /**
     * Variant not found
     *
     * Code: `1416`
...
class Upload {
    ...
    async upload(url, { formData, timeout }) {
        ...
        const formDataLength = await util.promisify(formData.getLength).call(formData);
