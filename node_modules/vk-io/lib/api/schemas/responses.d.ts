...
export declare type LeadsCheckUserResponse = Objects.LeadsChecked;
export declare type LeadsCompleteResponse = Objects.LeadsComplete;
export declare type LeadsGetStatsResponse = Objects.LeadsLead;
export declare type LeadsGetUsersResponse = Objects.LeadsEntry[];
...
export declare type LeadsStartResponse = Objects.LeadsStart;
...
export declare type PhotosGetByIdExtendedResponse = Objects.PhotosPhotoFull[];
...
export declare type PodcastsGetPopularResponse = Objects.PodcastPopularPodcast[];
export declare type PodcastsGetRecentSearchRequestsResponse = string[];
...
export declare type StorageGetV5110Response = Objects.StorageValue[];
